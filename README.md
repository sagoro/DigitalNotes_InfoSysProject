...
A Pyhton-Flask project for my University course "Information Systems".

Εργασία εξαμήνου για το μάθημα "Πληροφοριακά Συστήματα" Εαρινό 2022 - Αγορόπουλος Στέλιος.
...
To Request Body δεν καλύπτει το Required Schema: https://prnt.sc/w_SNNYi16Uij
...
Όλα τα δεδομένα της εφαρμογής αποθηκεύονται σε έναν φάκελο του host με το όνομα **data**. Έχουν γίνει mount τα volumes της MongoDB στον συγκεκριμένο φάκελο, ώστε να αποφευχθεί η απώλεια δεδομένων σε περίπτωση που διαγραφεί το container της MongoDB.
